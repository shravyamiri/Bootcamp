...
class Novel(Book):
    # Constructor for Novel with genre as a new attribute
...
# Create an instance of the Novel class with a specific genre
novel = Novel("1984", "Orwell", "Dystopian")

# Print the description to include the genre
